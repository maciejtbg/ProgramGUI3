...
//        }
        (new ScreenShotTaker(poczX, poczY, konX, konY)).makeAndSave(new File(nazwaPliku + ".png"));
//        System.out.println("Zrobilem zrzut ekranu: "+RESOURCES_DIR+"/"+nazwaPliku+".png");
    }

    public BufferedImage zrobZdjecieDoPamieci() {
        BufferedImage zdjecieWPamieci = robot.createScreenCapture(screenRct);
        return zdjecieWPamieci;
    }
